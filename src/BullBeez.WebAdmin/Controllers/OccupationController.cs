...
namespace BullBeez.WebAdmin.Controllers
{
    ...
    public class OccupationController : Controller
    {
        ...
        public async Task<ActionResult> GetOccupationList(DataTablesRequest dataRequest)
        {
            var json = _Serializer.Serialize(new { take = dataRequest.length, skip = dataRequest.start, search = dataRequest.Search.Value, CommonType = 1 });
        ...
        public async Task<ActionResult> GetOccupationListSelect()
        {
            var json = _Serializer.Serialize(new { take = 0, skip = 1000, search = "", CommonType = 1 });
        ...
        public async Task<ActionResult> GetOccupationById(GetCommonDataByIdRequest request)
        {
            var json = _Serializer.Serialize(new { Id = request.Id, CommonType = 1 });
        ...
        public async Task<ActionResult> GetOccupationInsetOrUpdate(CommonDataInsertOrUpdate request)
        {
