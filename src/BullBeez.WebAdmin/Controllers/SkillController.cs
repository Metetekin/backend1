...
namespace BullBeez.WebAdmin.Controllers
{
    public class SkillController : Controller
    {
        ...
        public async Task<ActionResult> GetSkillList(DataTablesRequest dataRequest)
        {
            var json = _Serializer.Serialize(new { take = dataRequest.length, skip = dataRequest.start, search = dataRequest.Search.Value, CommonType = 3 });
        ...
        public async Task<ActionResult> GetSkillById(GetCommonDataByIdRequest request)
        {
            var json = _Serializer.Serialize(new { Id = request.Id, CommonType = 3 });
        ...
        public async Task<ActionResult> GetSkillInsetOrUpdate(CommonDataInsertOrUpdate request)
        {
