...
{
    public class CompanyLevelController : Controller
    {
        ...
        public async Task<ActionResult> GetCompanyLevelList(DataTablesRequest dataRequest)
        {
            var json = _Serializer.Serialize(new { take = dataRequest.length, skip = dataRequest.start, search = dataRequest.Search.Value, CommonType = 5 });
        ...
        public async Task<ActionResult> GetCompanyLevelById(GetCommonDataByIdRequest request)
        {
            var json = _Serializer.Serialize(new { Id = request.Id, CommonType = 5 });
        ...
        public async Task<ActionResult> GetCompanyLevelInsetOrUpdate(CommonDataInsertOrUpdate request)
        {
            request.CommonType = 5;
