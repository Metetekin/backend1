...
namespace BullBeez.Data.Migrations
{
    ...
    [Migration("20210712133038_Version_1.3")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BullBeez.Core.Entities.ComponyAndPersonOccupation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CompanyAndPersonProject", b =>
                {
                    b.Property<int>("CompanyAndPersonId")
                        .HasColumnType("int");
                    ...
                    b.HasKey("CompanyAndPersonId", "ProjectId");
            ...
            modelBuilder.Entity("CompanyAndPersonSkill", b =>
                {
                    b.Property<int>("CompanyAndPersonId")
                        .HasColumnType("int");
                    ...
                    b.HasKey("CompanyAndPersonId", "SkillId");

                    b.HasIndex("SkillId");

                    b.ToTable("CompanyAndPersonSkill");
                });
            ...
            modelBuilder.Entity("BullBeez.Core.Entities.ComponyAndPersonOccupation", b =>
                {
                    b.HasOne("BullBeez.Core.Entities.CompanyAndPerson", "CompanyAndPerson")
                        .WithMany("ComponyAndPersonOccupation")
                        .HasForeignKey("CompanyAndPersonId");
            ...
            modelBuilder.Entity("CompanyAndPersonProject", b =>
                {
                    b.HasOne("BullBeez.Core.Entities.CompanyAndPerson", null)
                        .WithMany()
                        .HasForeignKey("CompanyAndPersonId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("BullBeez.Core.Entities.Project", null)
                        .WithMany()
            ...
            modelBuilder.Entity("CompanyAndPersonSkill", b =>
                {
                    ...
                    b.HasOne("BullBeez.Core.Entities.Skill", null)
                        .WithMany()
            ...
            modelBuilder.Entity("InterestProject", b =>
                {
                    b.HasOne("BullBeez.Core.Entities.Interest", null)
                        .WithMany()
            ...
            modelBuilder.Entity("BullBeez.Core.Entities.CompanyAndPerson", b =>
                {
                    ...
                    b.Navigation("ComponyAndPersonOccupation");
